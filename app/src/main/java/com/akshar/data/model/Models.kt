...
data class Bill(
    ...
    val type: String, // "EXPENSE" or "INCOME"
    val category: String,
    val startDate: Long, // timestamp in ms (first due date)
    val recurrence: String, // "NONE", "DAILY", "WEEKLY", "MONTHLY", "YEARLY"
    val accountId: Long? = null, // Optional account reference
    val reminderLeadTimeDays: Int = 0,
...
data class BillOccurrence(
    ...
    val state: String // "PAID", "SKIPPED", "PENDING"
)
